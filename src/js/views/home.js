...
export const Home = () => (
		<div className="text-center mt-5">
			...
			<div className="card-group">
				<div className="card">
					<img src="https://cdn.hobbyconsolas.com/sites/navi.axelspringer.es/public/media/image/2020/10/anakin-padme-star-wars-episodio-iii-2090677.jpg?tf=3840x" className="card-img-top" alt="..." />
				...
				<div className="card">
					<img src="https://preview.redd.it/omwdzg42vj2e1.jpeg?auto=webp&s=b28d6381a042e4339773b140c928889647bb212a" className="card-img-top" alt="..." />
					<div className="card-body">
				...
				<div className="card">
					<img src="https://cdn.hobbyconsolas.com/sites/navi.axelspringer.es/public/media/image/2020/05/darth-vader-star-wars-1938913.jpg?tf=3840x" className="card-img-top" alt="..." />
					<div className="card-body">
